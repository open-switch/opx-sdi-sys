...
/**
 * @brief  Check lpc device access for the specified entity.
 * @param[in] hdl - handle to the entity whose information has to be retrieved.
 * lpc_bus_failure[out] - true if test fails, false otherwise
 * @return - @ref t_std_error
 */

t_std_error sdi_entity_lpc_bus_check(sdi_entity_hdl_t hdl, bool *lpc_bus_failure);
